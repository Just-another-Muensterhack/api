...
Revision ID: 4d939b987315
Revises: bf394f648d10
Create Date: 2022-09-24 03:36:09.916271
...
revision = '4d939b987315'
down_revision = 'bf394f648d10'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('id', postgresql.UUID(), autoincrement=False, nullable=False),
    sa.Column('status', postgresql.ENUM('in_progress', 'cancelled', 'completed', name='status'), autoincrement=False, nullable=True),
    ...
    sa.Column('role', postgresql.ENUM('admin', 'support', 'user', name='role'), autoincrement=False, nullable=True),
    ...
    op.create_index('ix_registered_users_phone_number', 'registered_users', ['phone_number'], unique=False)
    ...
    op.create_index('ix_registered_users_first_name', 'registered_users', ['first_name'], unique=False)
